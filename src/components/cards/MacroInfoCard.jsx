...
export function MacroCard({ titulo, valor, desc, fecha, id, chart: { duration, type } }) {
    ...
    return (
        <article className={`w-[90vw] sm:h-[330px] sm:w-[400px] m-auto p-6 rounded-[15px] shadow-xl border-[1px] border-gray-300 bg-white dark:border-gray-900 dark:bg-slate-900
            flex flex-col justify-between hover:scale-[1.02] transition-transform duration-300 hover:cursor-pointer`}
        >
            <a href={`Economia/${id}`}>
                <div>
